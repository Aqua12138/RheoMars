...
class Gathering2Env(FluidEnv):
    def __init__(self, version, loss=True, loss_type='diff', seed=None, renderer_type='GGUI'):
        ...
        self.target_file = get_tgt_path('Gathering2-v0.pkl')
    ...
    def setup_agent(self):
        ...
        agent_cfg.merge_from_file(get_cfg_path('agent_gathering2.yaml'))
    ...
    def setup_loss(self):
        self.taichi_env.setup_loss(
            loss_cls=Gathering2Loss,
            type=self.loss_type,
            matching_mat=MILK_VIS,
            target_file=self.target_file,
            weights={'sdf': 0, 'density': 10, 'contact': 0, 'is_soft_contact': False}
        )
